...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-14 px-6 relative overflow-hidden" ref={containerRef}>
      {/* Background Elements */}
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto" style={{ perspective: "1500px" }}>
          ...
          <div className="space-y-10 md:space-y-20 pl-12 md:pl-0">
            ...
            {/* Item 1: Bio */}
            <div className="flex flex-col md:flex-row items-center justify-between w-full relative" ref={addToRefs}>
              <div className="w-full md:w-[45%] md:pr-12">
                {/* REMOVED text-right from here and sub-elements */}
                <motion.div whileHover={{ scale: 1.02 }} className="gradient-border p-8 card-hover bg-card/50 backdrop-blur-sm text-left inline-block w-full shadow-2xl shadow-primary/10">
                  <div className="flex items-start gap-4 mb-6">
                    <div className="p-3 rounded-xl bg-primary/10 text-primary shrink-0">
                      <User className="h-8 w-8" />
                    </div>
                    <div className="w-full">
                      <h3 className="text-2xl font-bold">The Developer Behind the Code</h3>
                      <p className="text-sm text-primary font-medium">Passionate & Dedicated</p>
                    </div>
                  </div>
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    <p>
                      I am a <span className="text-foreground font-semibold">Full-Stack MERN Developer</span> with a deep love for building clean, responsive, and modern web applications.
                    </p>
                    <p>
                      My journey is fueled by curiosity and a relentless drive to improve. Even as I start my career, I treat every line of code as an opportunity to learn.
                    </p>
                    <p>
                      I believe in the power of <span className="text-foreground font-semibold">consistent learning</span>. Whether it's mastering a new framework or optimizing backend performance, I am always pushing my boundaries.
                    </p>
                  </div>
                  <div className="mt-8 flex gap-4">
                    <a href="#contact" className="cosmic-button text-sm">Let's Connect</a>
                    <a href="https://drive.google.com/file/d/1RkCcK-j0Gir0c5N9B_olTuJK3pc6_TYV/view?usp=drive_link" target="_blank" rel="noreferrer" className="px-6 py-2 rounded-full border border-border hover:bg-primary/5 transition-colors text-sm font-medium flex items-center gap-2">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full relative" ref={addToRefs}>
              ...
              <div className="w-full md:w-[45%] md:pl-12">
                <motion.div whileHover={{ scale: 1.02 }} className="gradient-border p-8 card-hover bg-card/50 backdrop-blur-sm text-left inline-block w-full shadow-2xl shadow-purple-500/10">
                  <div className="mb-6">
                    ...
                    <p className="text-muted-foreground text-sm mb-6">
                      Specializing in the MERN stack, but always exploring new horizons.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    {[
                      "React", "Node.js", "MongoDB", "Tailwind", "Next.js", 
                      "Express", "Firebase", "typescript", "vercel", "netlify", "nextAuth"
                    ].map((tech) => (
                      <span key={tech} className="px-3 py-1 rounded-full bg-secondary/50 text-xs font-medium border border-border/50">
                        {tech}
                      </span>
                    ))}
                  </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full relative" ref={addToRefs}>
              <div className="w-full md:w-[45%] md:pr-12">
                <motion.div whileHover={{ scale: 1.02 }} className="gradient-border p-8 card-hover bg-card/50 backdrop-blur-sm text-left inline-block w-full shadow-2xl shadow-blue-500/10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full relative" ref={addToRefs}>
              ...
              <div className="w-full md:w-[45%] md:pl-12">
                <motion.div whileHover={{ scale: 1.02 }} className="gradient-border p-8 card-hover bg-card/50 backdrop-blur-sm flex flex-col sm:flex-row items-start gap-6 shadow-2xl shadow-green-500/10">
